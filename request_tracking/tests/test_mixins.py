...
@override_settings(ROOT_URLCONF="request_tracking.tests.urls")
class TestLogging(APITestCase):
    ...
    def test_log_params(self):
        ...
        log = APIRequestLog.objects.first()
        self.assertEqual(
            ast.literal_eval(log.query_params), {"p1": "a", "another": "2"}
        )
    ...
    def test_log_params_cleaned_from_personal_list(self):
        ...
        self.assertEqual(
            ...
            {
                "api": BaseLogging.CLEANED_SUBSTITUTE,
                "capitalized": "12345",
                "my_field": BaseLogging.CLEANED_SUBSTITUTE,
            },
        )
    ...
    @mock.patch("request_tracking.models.APIRequestLog.save")
    ...
    @mock.patch("request_tracking.mixins.base_logging.now")
