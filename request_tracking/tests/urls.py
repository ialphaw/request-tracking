...
urlpatterns = [
    ...
    path(
        "sensitive-fields-logging/", test_views.MockSensitiveFieldsLoggingView.as_view()
    ),
    path(
        "invalid-cleaned-substitute-logging/",
        test_views.MockInvalidCleanedSubstituteLoggingView.as_view(),
    ),
]
